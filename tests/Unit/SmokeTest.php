 ...
 * satisfies the harness contracts, and the provider registers what the
...
it('assembles the gateway without reading the API key', function (): void {
    ...
    $app->set(DispatcherInterface::class, Dispatcher::class);
    $app->set(RedirectorInterface::class, FakeRedirector::class);
